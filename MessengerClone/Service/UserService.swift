...
class UserService {
    ...
    @MainActor
    func fetchCurrectUser() async throws {
    ...
    static func fetchAll( limit : Int? = nil ) async throws -> [User] {
    ...
    static  func fetchUser (withUid uid : String , complecion : @escaping(User) -> Void){
